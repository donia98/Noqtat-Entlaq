                    ...
                    <table class="table table-checkable" id="kt_datatable2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td>2</td>
                                <td>جمعية عائشة للخدمات الإجتماعية وحقوق المرأة</td>
                                <td>خدمة اجتماعية</td>
                                <td>12/02/2021</td>
                                <td nowrap="nowrap"><span
                        ...
                        <div class="form-group row">
                            <div class="col-lg-8">
                                ...
                                <textarea name="" id="" cols="30" rows="5" class="form-control"
                                    disabled="disabled">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit eligendi dignissimos molestias earum eveniet voluptatibus, facilis, rem, voluptatum porro ipsam alias ut quo cumque. Nesciunt accusantium magnam repellendus praesentium nihil!</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-8">
                                ...
                                <textarea name="" id="" cols="30" rows="5"
                                    class="form-control">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit eligendi dignissimos molestias earum eveniet voluptatibus, facilis, rem, voluptatum porro ipsam alias ut quo cumque. Nesciunt accusantium magnam repellendus praesentium nihil!</textarea>
                            </div>
                        </div>
                        <div class="separator separator-dashed my-5"></div>
                        <h5>فترة التدريب</h5>
